...
def dbfetch(sql):
     print(sql)
     try:
      con = psycopg2.connect(user='bzqmsoxeojuidi',password='9d1b37b30bcff893a0f1a1015df9cdd359ef80771f298ae5c87bf9053eb954fb',host='ec2-54-75-230-41.eu-west-1.compute.amazonaws.com',port='5432',database='d61vrqc4u9so8q')
      cur = con.cursor()
